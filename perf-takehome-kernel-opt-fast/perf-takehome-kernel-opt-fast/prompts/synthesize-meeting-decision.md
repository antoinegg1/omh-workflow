...
Return raw JSON only. Do not use Markdown fences, comments, prose outside the JSON, or placeholder strings. The `data` object and the `/meeting/decision` patch value must contain the same concrete JSON object.
