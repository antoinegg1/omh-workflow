...
import { normalizeFailureFingerprint } from "./agentkaggle-opt-sol-3x2/scripts/campaign-controls.js";
...
async function runAttempt(input: {
	...
	const env: Record<string, string> = {
		...
		SOL_H800_WORKER_LANES: "3",
		SOL_H800_SEARCH_AGENTS: "2",
		SOL_H800_SIMPLIFY_PLAN: "off",
...
function parseArgs(args: string[]): SupervisorOptions {
	...
	return {
		...
		flow: path.resolve(values.get("flow") ?? "/root/omh-workflow/agentkaggle-opt-sol-3x2/agentkaggle-opt-sol-3x2.omhflow"),
