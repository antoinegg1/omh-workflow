...
if (!checks.validationReady) {
	throw new Error(
		...
		}. Use /mnt/public/lichangye/envs/sol-local, keep /mnt/public/lichangye/SOL-ExecBench read-only and clean, keep scripts/h800_timing_adapter/sitecustomize.py available, and do not install or select another validation environment.`,
	);
}
